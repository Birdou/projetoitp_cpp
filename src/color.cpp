...
{
	red <= 0 ? this->r = 0 : red >= 255 ? this->r = 255 : this->r = red;
	green <= 0 ? this->g = 0 : green >= 255 ? this->g = 255 : this->g = green;
...
{
	value <= 0 ? this->r = 0 : value >= 255 ? this->r = 255 : this->r = value;
}
...
{
	value <= 0 ? this->g = 0 : value >= 255 ? this->g = 255 : this->g = value;
}
...
{
	value <= 0 ? this->b = 0 : value >= 255 ? this->b = 255 : this->b = value;
}

...
std::string paintit::command_help(const std::string &command)
{
	...
	{
		std::cout << "Save: save [JPG|PNG|BMP] [caminho]" << std::endl
				  << "\tSalva a imagem no formato especificado." << std::endl;
	}
	else if (lib::cstrcmp(command, "open") == 0)
	{
		std::cout << "Open: open [caminho]" << std::endl
				  << "\tCarrega uma preexistente." << std::endl;
	}
	else if (lib::cstrcmp(command, "scolor") == 0)
	{
		std::cout << "Special color: scolor [cor]" << std::endl
	...
	{
		std::cout << "Special clear: sclear [cor]" << std::endl
	...
	{
		std::cout << "Glitch: glitch [distancia] [ângulo]" << std::endl
				  << "\tAplica um efeito de distanciamento dos planos de cores de acordo com o ângulo informado;" << std::endl;
	}
	else if (lib::cstrcmp(command, "rbglitch") == 0)
	{
		std::cout << "RBGlitch: rbglitch [distância] [ângulo]" << std::endl
	...
	{
		std::cout << "Intensity: intensity [0-100] [0-100] [0-100]" << std::endl
	...
	{
		std::cout << "Red equalizer: redequal [0-100] [0-100] [0-100]" << std::endl
	...
	{
		std::cout << "Green equalizer: greenequal [0-100] [0-100] [0-100]" << std::endl
	...
	{
		std::cout << "Blue equalizer: blueequal [0-100] [0-100] [0-100]" << std::endl
	...
	{
		std::cout << "Desaturate: desaturate [0-100] [0-100] [0-100]" << std::endl
	...
	{
		std::cout << "List color: listcolor" << std::endl
				  << "\tExibe uma mensagem listando algumas cores predefinidas pelo programa;" << std::endl;
	}
	else if (lib::cstrcmp(command, "curve") == 0)
	{
		std::cout << "Curve: curve [pontos] [X1] [Y1] ... [X pontos] [Y pontos]" << std::endl
				  << "\tDesenha uma curva de Bézier de ordem \\\"pontos\\\";" << std::endl;
	}
	else if (lib::cstrcmp(command, "elipse") == 0)
	{
		std::cout << "Elipse: elipse [linha] [coluna] [largura] [altura]" << std::endl
